...
for i in range(1, 6):
    ...
    print("Year: ", year, "Beginning Balance: ", f"{principal:,.2f}", "Ending Balance: ", f"{endingBalance:,.2f}")
    principal = endingBalance
    year = year + 1

print("Total Interest Earned: ", f"{totalInterest:,.2f}")

# Fibonacci sequence is a sequence of natural order. The sequence is: 1, 1, 2, 3, 5, 8 etc. where it is a series of numbers that may start with 0 and 1, and each subsequent number is the sum of the
